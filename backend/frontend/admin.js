...
function renderSettings(settings){
 const map=Object.fromEntries(settings.map(x=>[x.setting_key,x.setting_value]));
 const hiddenSettings=new Set(["roulette_max_bet","signup_bonus_amount","deposit_bonus_percent","pix_enabled","pix_key","pix_key_type","pix_city","pix_description","pix_instructions","pix_receiver_name","audit_log_retention_days"]); const visible=settings.filter(x=>!hiddenSettings.has(x.setting_key));
