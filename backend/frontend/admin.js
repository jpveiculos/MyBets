...
function renderSettings(settings){
 const map=Object.fromEntries(settings.map(x=>[x.setting_key,x.setting_value]));
 const visible=settings.filter(x=>!["roulette_min_bet","roulette_max_bet","signup_bonus_amount","bonus_wager_requirement","roulette_prizes"].includes(x.setting_key));
